...
import { Hunter, HunterSkills } from "../hunter/hunter";
...
export type SniperSkillParams = HunterSkills & {
  "Bow Master": typeof NumberParam;
  "Arrow Storm": typeof NumberParam;
  "Wind Walk": typeof NumberParam;
  Camouflage: typeof NumberParam;
  "Falcon Assault": typeof NumberParam;
  "Falcon Claws": typeof NumberParam;
  "True Sight": typeof NumberParam;
  "Fear Breeze": typeof NumberParam;
  "Sharp Shooting": typeof NumberParam;
  "Sticky Trap": typeof NumberParam;
  Unlimit: typeof NumberParam;
...
export const Sniper = () => {
  ...
  const [query, setQuery] = useQueryParams<SniperSkillParams>({
    ...
    "Skid Trap": NumberParam,
    "Ankle Snare": NumberParam,
    "Beast Bane": NumberParam,
    "Falcon Mastery": NumberParam,
    "Blitz Beat": NumberParam,
    Detect: NumberParam,
    Flasher: NumberParam,
    "Freezing Trap": NumberParam,
    "Land Mine": NumberParam,
    "Remove Trap": NumberParam,
    "Shockwave Trap": NumberParam,
    Sandman: NumberParam,
    "Blast Mine": NumberParam,
    "Claymore Trap": NumberParam,
    "Spring Trap": NumberParam,
    "Steel Crow": NumberParam,
    "Talkie Box": NumberParam,
    "Bow Master": NumberParam,
    "Arrow Storm": NumberParam,
    "Wind Walk": NumberParam,
    Camouflage: NumberParam,
    "Falcon Assault": NumberParam,
    "Falcon Claws": NumberParam,
    "True Sight": NumberParam,
    "Fear Breeze": NumberParam,
    "Sharp Shooting": NumberParam,
    "Sticky Trap": NumberParam,
    Unlimit: NumberParam,
  ...
  const skillNames = sniperSkills?.map((e) => e.name);
