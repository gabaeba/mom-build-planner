...
import { Priest, PriestSkills } from "../priest/priest";
...
export type HighPriestSkillParams = PriestSkills & {
  Clementia: typeof NumberParam;
  Ancilla: typeof NumberParam;
  Assumptio: typeof NumberParam;
  Basilica: typeof NumberParam;
  "Canto Candidus": typeof NumberParam;
  Vituperatum: typeof NumberParam;
  Clearance: typeof NumberParam;
  "Coluceo Heal": typeof NumberParam;
  Convenio: typeof NumberParam;
  "High Heal": typeof NumberParam;
  Epiclesis: typeof NumberParam;
  Meditatio: typeof NumberParam;
  Offertorium: typeof NumberParam;
  Praefatio: typeof NumberParam;
  Sacrament: typeof NumberParam;
...
export const HighPriest = () => {
  ...
  const [query, setQuery] = useQueryParams<HighPriestSkillParams>({
    ...
    Magnificat: NumberParam,
    "Lex Divina": NumberParam,
    "Lex Aeterna": NumberParam,
    Gloria: NumberParam,
    "B. S. Sacramenti": NumberParam,
    "Status Recovery": NumberParam,
    Resurrection: NumberParam,
    Sanctuary: NumberParam,
    Suffragium: NumberParam,
    "Safety Wall": NumberParam,
    Exorcismus: NumberParam,
    "Magnus Exorcismus": NumberParam,
    Clementia: NumberParam,
    Ancilla: NumberParam,
    Assumptio: NumberParam,
    Basilica: NumberParam,
    "Canto Candidus": NumberParam,
    Vituperatum: NumberParam,
    Clearance: NumberParam,
    "Coluceo Heal": NumberParam,
    Convenio: NumberParam,
    "High Heal": NumberParam,
    Epiclesis: NumberParam,
    Meditatio: NumberParam,
    Offertorium: NumberParam,
    Praefatio: NumberParam,
    Sacrament: NumberParam,
  ...
  const skillNames = highPriestSkills?.map((e) => e.name);
