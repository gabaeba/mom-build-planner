...
import { Monk, MonkSkills } from "../monk/monk";
...
export type ChampionSkillParams = MonkSkills & {
  Zen: typeof NumberParam;
  "Palm Push Strike": typeof NumberParam;
  "Tiger Knuckle Fist": typeof NumberParam;
  "Chain Crush Combo": typeof NumberParam;
  "Flash Combo": typeof NumberParam;
  "Dragon Combo": typeof NumberParam;
  "Fallen Empire": typeof NumberParam;
  Windmill: typeof NumberParam;
  "Lightning Walk": typeof NumberParam;
  "Knuckle Arrow": typeof NumberParam;
  "Crescent Elbow": typeof NumberParam;
  "Curing Touch": typeof NumberParam;
  "Quiet Touch": typeof NumberParam;
  "Energizing Touch": typeof NumberParam;
  "Changing Touch": typeof NumberParam;
  "Revitalizing Touch": typeof NumberParam;
  "Spiritual Concentration": typeof NumberParam;
...
export const Champion = () => {
  ...
  const [query, setQuery] = useQueryParams<ChampionSkillParams>({
    ...
    Pneuma: NumberParam,
    "Iron Hand": NumberParam,
    "Call Spirits": NumberParam,
    "Absorb Spirits": NumberParam,
    Dodge: NumberParam,
    Fury: NumberParam,
    Investigate: NumberParam,
    "Finger Offensive": NumberParam,
    "Asura Strike": NumberParam,
    "Triple Attack": NumberParam,
    "Chain Combo": NumberParam,
    "Combo Finish": NumberParam,
    "Steel Body": NumberParam,
    "Blade Stop": NumberParam,
    "Spirits Recovery": NumberParam,
    "Body Relocation": NumberParam,
    Zen: NumberParam,
    "Palm Push Strike": NumberParam,
    "Tiger Knuckle Fist": NumberParam,
    "Chain Crush Combo": NumberParam,
    "Flash Combo": NumberParam,
    "Dragon Combo": NumberParam,
    "Fallen Empire": NumberParam,
    Windmill: NumberParam,
    "Lightning Walk": NumberParam,
    "Knuckle Arrow": NumberParam,
    "Crescent Elbow": NumberParam,
    "Curing Touch": NumberParam,
    "Quiet Touch": NumberParam,
    "Energizing Touch": NumberParam,
    "Changing Touch": NumberParam,
    "Revitalizing Touch": NumberParam,
    "Spiritual Concentration": NumberParam,
  ...
  const skillNames = championSkills?.map((e) => e.name);
        ...
        <div className={skillTree}>
          ...
          <div>
            ...
            >
              ...
              />
              <SkillComponent
                skill={palmPushStrike}
                handleKeyPress={handleKeyPress}
                isHovered={isHovered}
                setIsHovered={setIsHovered}
              />
              <SkillComponent
                skill={tigerKnuckleFist}
                handleKeyPress={handleKeyPress}
                isHovered={isHovered}
                setIsHovered={setIsHovered}
              />
              <SkillComponent
                skill={chainCrushCombo}
                handleKeyPress={handleKeyPress}
                isHovered={isHovered}
                setIsHovered={setIsHovered}
              />
              ...
              />
              <SkillComponent
                skill={revitalizingTouch}
                handleKeyPress={handleKeyPress}
                isHovered={isHovered}
                setIsHovered={setIsHovered}
              />
              <SkillComponent
                skill={spiritualConcentration}
                handleKeyPress={handleKeyPress}
                isHovered={isHovered}
                setIsHovered={setIsHovered}
              />
