...
import { Crusader, CrusaderSkills } from "../crusader/crusader";
...
export type PaladinSkillParams = CrusaderSkills & {
  "Banishing Point": typeof NumberParam;
  "Pinpoint Attack": typeof NumberParam;
  "Cannon Spear": typeof NumberParam;
  "Clashing Spiral": typeof NumberParam;
  Inspiration: typeof NumberParam;
  "Divine Glyph": typeof NumberParam;
  "Divine Punishment": typeof NumberParam;
  "Exceed Break": typeof NumberParam;
  Gospel: typeof NumberParam;
  "Moon Slasher": typeof NumberParam;
  Overbrand: typeof NumberParam;
  Pressure: typeof NumberParam;
  "Ray of Genesis": typeof NumberParam;
...
export const Paladin = () => {
  ...
  const [query, setQuery] = useQueryParams<PaladinSkillParams>({
    Bash: NumberParam,
    Provoke: NumberParam,
    Endure: NumberParam,
    ...
    "Shield Boomerang": NumberParam,
    "Holy Cross": NumberParam,
    Cure: NumberParam,
    Defender: NumberParam,
    "Repel Evil": NumberParam,
    Faith: NumberParam,
    "Grand Cross": NumberParam,
    Heal: NumberParam,
    Providence: NumberParam,
    "Reflect Shield": NumberParam,
    Devotion: NumberParam,
    "Spear Quicken": NumberParam,
    "Banishing Point": NumberParam,
    "Pinpoint Attack": NumberParam,
    "Cannon Spear": NumberParam,
    "Clashing Spiral": NumberParam,
    Inspiration: NumberParam,
    "Divine Glyph": NumberParam,
    "Divine Punishment": NumberParam,
    "Exceed Break": NumberParam,
    Gospel: NumberParam,
    "Moon Slasher": NumberParam,
    Overbrand: NumberParam,
    Pressure: NumberParam,
    "Ray of Genesis": NumberParam,
  ...
  const skillNames = paladinSkills?.map((e) => e.name);
