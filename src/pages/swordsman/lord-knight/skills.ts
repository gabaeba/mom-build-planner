...
export const auraBlade: Skill = {
  ...
  icon: "src/assets/lord-knight/aura_blade.png",
...
export const berserk: Skill = {
  ...
  maxLevel: 5,
  type: SkillType.active,
  icon: "src/assets/lord-knight/berserk.png",
  preRequisites: [],
};
...
export const clashingSpiral: Skill = {
  ...
  icon: "src/assets/lord-knight/clashing_spiral.png",
  preRequisites: [],
};
...
export const concentration: Skill = {
  ...
  maxLevel: 5,
  type: SkillType.active,
  icon: "src/assets/lord-knight/concentration.png",
  preRequisites: [
...
export const defensiveStance: Skill = {
  ...
  maxLevel: 5,
  type: SkillType.active,
  icon: "src/assets/lord-knight/defensive_stance.png",
  preRequisites: [
...
export const headCrush: Skill = {
  ...
  maxLevel: 5,
  type: SkillType.offensive,
  icon: "src/assets/lord-knight/head_crush.png",
...
export const ignitionBreak: Skill = {
  ...
  maxLevel: 10,
  type: SkillType.offensive,
  icon: "src/assets/lord-knight/ignition_break.png",
  preRequisites: [
    { skill: bash, level: 10 },
...
export const jointBeat: Skill = {
  ...
  maxLevel: 5,
  type: SkillType.offensive,
  icon: "src/assets/lord-knight/joint_beat.png",
...
export const majesticSword: Skill = {
  ...
  maxLevel: 5,
  type: SkillType.active,
  icon: "src/assets/lord-knight/majestic_sword.png",
...
export const parry: Skill = {
  ...
  maxLevel: 10,
  type: SkillType.active,
  icon: "src/assets/lord-knight/parry.png",
  preRequisites: [
...
export const phantomThrust: Skill = {
  ...
  maxLevel: 5,
  type: SkillType.offensive,
  icon: "src/assets/lord-knight/phantom_thrust.png",
...
export const tensionRelax: Skill = {
  ...
  icon: "src/assets/lord-knight/tension_relax.png",
...
export const vendetta: Skill = {
  ...
  maxLevel: 5,
  type: SkillType.offensive,
  icon: "src/assets/lord-knight/vendetta.png",
  preRequisites: [
