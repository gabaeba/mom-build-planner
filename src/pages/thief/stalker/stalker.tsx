...
import { Rogue, RogueSkills } from "../rogue/rogue";
...
export type StalkerSkillParams = RogueSkills & {
  "Violent Stab": typeof NumberParam;
  "Bow Master": typeof NumberParam;
  "Triangle Shot": typeof NumberParam;
  Manhole: typeof NumberParam;
  "Dimension Door": typeof NumberParam;
  "Bloody Lust": typeof NumberParam;
  "Chaos Panic": typeof NumberParam;
  "Stalker's Instinct": typeof NumberParam;
  "Deadly Infect": typeof NumberParam;
  "Emergency Escape": typeof NumberParam;
  "Explosive Satchel": typeof NumberParam;
  "Feint Bomb": typeof NumberParam;
  Reproduce: typeof NumberParam;
...
export const Stalker = () => {
  ...
  const [query, setQuery] = useQueryParams<StalkerSkillParams>({
    ...
    Snatcher: NumberParam,
    "Coin Sap": NumberParam,
    "Back Stab": NumberParam,
    "Strip Helm": NumberParam,
    "Strip Shield": NumberParam,
    "Strip Armor": NumberParam,
    "Strip Weapon": NumberParam,
    "Vulture's Eye": NumberParam,
    "Double Strafing": NumberParam,
    "Tunnel Drive": NumberParam,
    Raid: NumberParam,
    Intimidate: NumberParam,
    Plagiarism: NumberParam,
    "Remove Trap": NumberParam,
    Graffiti: NumberParam,
    "Gangster's Paradise": NumberParam,
    Preserve: NumberParam,
    "Violent Stab": NumberParam,
    "Bow Master": NumberParam,
    "Triangle Shot": NumberParam,
    Manhole: NumberParam,
    "Dimension Door": NumberParam,
    "Bloody Lust": NumberParam,
    "Chaos Panic": NumberParam,
    "Stalker's Instinct": NumberParam,
    "Deadly Infect": NumberParam,
    "Emergency Escape": NumberParam,
    "Explosive Satchel": NumberParam,
    "Feint Bomb": NumberParam,
    Reproduce: NumberParam,
  ...
  const skillNames = stalkerSkills?.map((e) => e.name);
        ...
        <div className={skillTree}>
          ...
          <div>
            ...
            >
              ...
              />
              <SkillComponent
                skill={emergencyEscape}
                handleKeyPress={handleKeyPress}
                isHovered={isHovered}
                setIsHovered={setIsHovered}
              />
              <SkillComponent
                skill={explosiveSatchel}
                handleKeyPress={handleKeyPress}
                isHovered={isHovered}
                setIsHovered={setIsHovered}
              />
