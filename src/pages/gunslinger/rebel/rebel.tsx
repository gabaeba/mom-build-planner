...
import { Gunslinger, GunslingerSkills } from "../gunslinger/gunslinger";
...
export type RebelSkillParams = GunslingerSkills & {
  "Rich's Coin": typeof NumberParam;
  "Heat Barrel": typeof NumberParam;
  Flicker: typeof NumberParam;
  "Binding Trap": typeof NumberParam;
  "Fallen Angel": typeof NumberParam;
  "Fire Dance": typeof NumberParam;
  "Shattering Storm": typeof NumberParam;
  "Banishing Buster": typeof NumberParam;
  "Slug Shot": typeof NumberParam;
  "Mass Spiral": typeof NumberParam;
  "Anti-Material Blast": typeof NumberParam;
  "Hammer of God": typeof NumberParam;
  "Sniper's Perch": typeof NumberParam;
  "Quick Draw Shot": typeof NumberParam;
  "Howling Mine": typeof NumberParam;
  "Crimson Marker": typeof NumberParam;
  "Dragon Tail": typeof NumberParam;
  "Fire Rain": typeof NumberParam;
  "Round Trip": typeof NumberParam;
  "Platinum Alter": typeof NumberParam;
  "Lock and Load": typeof NumberParam;
  Overheat: typeof NumberParam;
  Bandolier: typeof NumberParam;
...
export const Rebel = () => {
  ...
  const [query, setQuery] = useQueryParams<RebelSkillParams>({
    "Single Action": NumberParam,
    "Coin Flip": NumberParam,
    "Coin Fling": NumberParam,
    "Last Stand": NumberParam,
    "Gatling Fever": NumberParam,
    Disarm: NumberParam,
    "Crippling Shot": NumberParam,
    Dust: NumberParam,
    "Spread Attack": NumberParam,
    "Full Buster": NumberParam,
    "Gunman Insignia": NumberParam,
    "Ground Drift": NumberParam,
    "Chain Action": NumberParam,
    "Bull's Eye": NumberParam,
    "Magic Bullet": NumberParam,
    "Rapid Shower": NumberParam,
    Desperado: NumberParam,
    Adjustment: NumberParam,
    Scavenger: NumberParam,
    "Rich's Coin": NumberParam,
    "Heat Barrel": NumberParam,
    Flicker: NumberParam,
    "Binding Trap": NumberParam,
    "Fallen Angel": NumberParam,
    "Fire Dance": NumberParam,
    "Shattering Storm": NumberParam,
    "Banishing Buster": NumberParam,
    "Slug Shot": NumberParam,
    "Mass Spiral": NumberParam,
    "Anti-Material Blast": NumberParam,
    "Hammer of God": NumberParam,
    "Sniper's Perch": NumberParam,
    "Quick Draw Shot": NumberParam,
    "Howling Mine": NumberParam,
    "Crimson Marker": NumberParam,
    "Dragon Tail": NumberParam,
    "Fire Rain": NumberParam,
    "Round Trip": NumberParam,
    "Platinum Alter": NumberParam,
    "Lock and Load": NumberParam,
    Overheat: NumberParam,
    Bandolier: NumberParam,
  ...
  const skillNames = rebelSkills?.map((e) => e.name);
        ...
        <div className={skillTree}>
          ...
          <div>
            ...
            <div className={skillGrid}>
              ...
              />
              <SkillComponent
                skill={shatteringStorm}
                handleKeyPress={handleKeyPress}
                isHovered={isHovered}
                setIsHovered={setIsHovered}
              />
              <SkillComponent
                skill={banishingBuster}
                handleKeyPress={handleKeyPress}
                isHovered={isHovered}
                setIsHovered={setIsHovered}
              />
